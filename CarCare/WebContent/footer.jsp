      ...
      <footer class="site-footer">
         <div class="footer-content">
            <div class="footer-column">
               <img src="logo_lexus.png" alt="Logo" class="footer-logo" />
               <ul>
            ...
            <div class="footer-column">
               <h4>Korea CarCare Social</h4>
               <ul class="social-media">
                  <li>
                     <a href="https://www.facebook.com/"><img src="logo_facebook.png" alt="Facebook" /></a>
                  </li>
                  <li>
                     <a href="https://www.instagram.com"><img src="logo_instargram.png" alt="Instagram" /></a>
                  </li>
                  <li>
                     <a href="https://www.youtube.com"><img src="logo_youtube.png" alt="YouTube" /></a>
                  </li>
                  <li>
                     <a href="https://twitter.com"><img src="logo_twitter.png" alt="Twitter" /></a>
                  </li>
               </ul>
            </div>
         </div>
